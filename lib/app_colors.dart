...
class AppColors {
  ...
  static const Color accent    = Color(0xFF26C6DA); // Mana Teal  (was 00E5FF — pure cyan)
  static const Color secondary = Color(0xFF4DD0E1); // Soft Cyan  (was 00FFFF — pure neon)

  static const Color danger  = Color(0xFFEF5350); // Ember Red   (was FF1744 — electric red)
  static const Color success = Color(0xFF66BB6A); // Forest Green (was 00E676 — pure neon green)
  static const Color gold    = Color(0xFFFFCA28); // Warm Amber  (was FFD600 — pure yellow)
