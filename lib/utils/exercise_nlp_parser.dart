...
class ExerciseNlpParser {
  ...
  static const _keywords = {
    ...
    'yoga', 'pilates',
    'hiit', 'cardio',
    'gym', 'workout', 'worked out',
    'weight', 'weights', 'lifting', 'strength training',
    'dance', 'danced', 'dancing', 'zumba',
    'elliptical', 'rowing', 'rowed',
    'jump rope', 'skipping',
    'basketball', 'football', 'soccer', 'tennis',
    'exercise', 'exercised', 'training', 'trained',
    'pushup', 'push-up', 'pull-up', 'pullup',
    'squat', 'lunge', 'plank',
