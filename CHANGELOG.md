...
### Added
- make alarm-style reminders opt-in and lock-screen-safe
...
### Fixed
- scroll a long confirm card, and let Nudgy actually log
- stop long advisor answers from being re-generated three times

## [1.1.78] - 2026-09-05

### Fixed
- say what the advisor is doing, and unstick confirm cards in a run

## [1.1.77] - 2026-09-05

### Fixed
- carry the Supabase token in a header CloudFront won't overwrite
...
### Added
- the confirm card, and the recurrence-scope control
- the finance tool executor, wired into the graph
- the client-side tool loop
- the finance tool catalogue, declared as data
- tool calling on adviseFinance, MCP-shaped catalogue

### Fixed
- give the advisor its own transport timeout
- give the model its length budget, and stop hiding truncation
...
### Fixed
- time Nudgy's double-click off the pointer event, not the wall clock
- stop a long table label pushing the figures out of frame
...
### Fixed
- stop short tile rows leaving a hole on the right
- draw the account icon the picker actually stored
...
### Fixed
- carry a recurring edit into the months already generated
...
### Fixed
- propagate budget edits to the dashboard and Hub
- close 18 mobile/web flow and UX inconsistencies

## [1.1.61] - 2026-08-15

### Added
- multi-select rows for batch settle, undo, and delete

### Fixed
- make deploy change-detection actually work
...
[Unreleased]: https://github.com/jojoneku/nudgr-fasting-habit-app/compare/v1.1.82...HEAD
