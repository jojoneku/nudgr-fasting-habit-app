...
_ADVISOR_SYSTEM_PREFIX = (
    ...
    "expected dates, credit cards per-card (owed / available / minimum due / due date), installment "
    "/ BNPL plans (fixed monthly commitments with months remaining), and next-month scheduled bills "
    "& receivables. A HISTORICAL BENCHMARK section, when present, gives month-by-month net worth "
    "and income vs. expenses. Only invoke rule 3 for a figure that is genuinely absent — not one "
    "you skimmed past.\n\n"
