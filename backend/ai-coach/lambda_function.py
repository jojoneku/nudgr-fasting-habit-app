...
_ADVISOR_SYSTEM_PREFIX = (
    ...
    "thing before saying you lack data. Present: liquid cash, income received, savings & goals, "
    "spending. Future: outstanding bills (money out) with due labels, receivables (money IN, owed "
    "to you) with expected dates, credit cards per-card (owed / available / minimum due / due "
    "date), and next-month scheduled bills & receivables. A HISTORICAL BENCHMARK section, when "
    "present, gives month-by-month net worth and income vs. expenses. Only invoke rule 3 for a "
    "figure that is genuinely absent — not one you skimmed past.\n\n"
