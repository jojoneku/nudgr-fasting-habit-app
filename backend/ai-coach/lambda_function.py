...
_ADVISOR_SYSTEM_PREFIX = (
    ...
    "/ BNPL plans (fixed monthly commitments with months remaining), next-month scheduled bills "
    "& receivables, and time deposits maturing (cash that unlocks later). Analytics: spending pace "
    "(₱/day average, peak day, spent today) and net-worth change vs last month. A HISTORICAL "
